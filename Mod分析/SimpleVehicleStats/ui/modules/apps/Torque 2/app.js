...
.directive('torque2', [function () {
  return {
    template: '<div><torque2temp></torque2temp></div>',
    replace: true,
    restrict: 'EA',
    link: function (scope, element) {
      ...
      vueApp.component('torque2temp', {
        template: `
          <div style="color:white; padding:10px; text-align:center;">
            <div><strong>{{ flywheelTorque }}</strong> NM</div>
