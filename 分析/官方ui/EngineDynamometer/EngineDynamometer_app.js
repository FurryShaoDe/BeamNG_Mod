        ...
        `<div style="height:100%; font-family:Consolas,Monaco,Lucida Console,Liberation Mono; background-color:rgba(255,255,255,0.9)">
          ...
          <div layout="row" layout-align="start end">
            <div >
              ...
              <div layout="column" ng-repeat="l in tickLabels track by $index" style="text-align: center; left:30px; position: absolute; top: {{ $index*tickSpacing }}px">
            ...
            <div >
              ...
              <div layout="column" ng-repeat="l in tickLabels track by $index" style="text-align: justify; right:40px; position: absolute; top: {{ $index*tickSpacing }}px">
                {{ (globalMax - $index*tickInterval).toFixed(0) }}
              </div>
            </div>
          </div>
